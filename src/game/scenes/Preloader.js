...
export class Preloader extends Scene
{
    ...
    preload ()
    {
        ...
        this.load.tilemapTiledJSON("mapa1", "nivel1.json");
        this.load.tilemapTiledJSON("mapa2", "nivel2.json");
        this.load.tilemapTiledJSON("mapa3", "nivel3.json");
        this.load.tilemapTiledJSON("mapa4", "nivel4.json");
        this.load.tilemapTiledJSON("mapa5", "nivel5.json");
        this.load.tilemapTiledJSON("mapa6", "nivel6.json");
