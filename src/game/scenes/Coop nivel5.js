...
export class CoopNivel5 extends Scene
{
    constructor ()
    {
        super('Coop nivel5');
    ...
    create ()
    {
        ...
        var mapa5 = this.make.tilemap({key: "mapaNivel5"});
        var patrones = mapa5.addTilesetImage("tileset", "patrones");
        var piso = mapa5.createLayer("bloques", patrones, 0, 0).setDepth(2);
        var paredes = mapa5.createLayer("paredes", patrones,0 ,0).setDepth(2);
        mapa5.createLayer("superficie", patrones, 0 , 0).setDepth(1);
        var final = mapa5.createLayer("final", patrones, 0, 0).setDepth(3);
        var rejillas = mapa5.createLayer("rejillas", patrones,0 ,0).setDepth(2);

        this.cajas = this.physics.add.group();

        this.capaSpawns = mapa5.getObjectLayer("spawn");
        ...
        this.capaInterruptores = mapa5.getObjectLayer("interruptores");
        ...
        this.capaAccionables = mapa5.getObjectLayer("accionables");
        ...
        // this.capaSirenas = mapa5.getObjectLayer("sirenas");
